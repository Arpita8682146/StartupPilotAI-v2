...
def ask_rag(question, history=None, api_key=None, n_results=4):
    ...
    """
    # Import here (not at top of file) to avoid a circular import with retriever.py,
    # which itself may import from this module.
